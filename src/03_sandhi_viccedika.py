...
def run_sh_file(cgi_file, input_file, output_file, input_encoding, lex="MW",
    ...
    for i in tqdm(range(len(input_list))):
        ...
        if(has_more_than_two_subwords(input_sent.lower())):
            count+=1
            final_words.append(input_sent)
            continue
    ...
    #save list of words in txt
    with open('./../inputs/no_suffix_unique.txt', 'w') as file:
